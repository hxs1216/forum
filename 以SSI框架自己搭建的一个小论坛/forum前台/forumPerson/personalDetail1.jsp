...
//更多我的帖子
function myComment(){
	document.forms[0].action="forum/forumAction!searchComment.action";
...
//更多我的消息
function mynews(){
	document.forms[0].action="forum/forumAction!myNews.action";
	document.forms[0].target="_self";
	document.forms[0].submit();
}
...
function comment(obj){
	document.forms[0].action="forum/forumAction!detail.action?isTopic=0&record.id="+obj;
	document.forms[0].target="_self";
	document.forms[0].submit();
}
     	...
     	<div style="margin-top: 0px;">
			<table width="1000"  align="center" cellpadding="0" cellspacing="0" border="0">
				<tr style="background-color: rgb(47,97,156); height: 40px;color: #ffffff;text-align: center;font-size: 15px;">
					<td id="index" style="width:100px;"  onmouseover="$(this).css('background-color','#3fb0f1');$('#person').css('background-color','rgb(47,97,156)');" onmouseout="$(this).css('background-color','rgb(47,97,156)');$('#person').css('background-color','#3fb0f1');" onclick="window.location.href='<%=basePath %>forum/forumAction!home.action'">首页</td>
					<td id="job" style="width:100px;" onmouseover="$(this).css('background-color','#3fb0f1');$('#person').css('background-color','rgb(47,97,156)');" onmouseout="$(this).css('background-color','rgb(47,97,156)');$('#person').css('background-color','#3fb0f1');" onclick="window.location.href='<%=basePath %>forum/forumAction!jobItems.action'">分享工作</td>
					<td id="live" style="width:100px;" onmouseover="$(this).css('background-color','#3fb0f1');$('#person').css('background-color','rgb(47,97,156)');" onmouseout="$(this).css('background-color','rgb(47,97,156)');$('#person').css('background-color','#3fb0f1');" onclick="window.location.href='<%=basePath %>forum/forumAction!liveItems.action'">分享生活</td>
					<td id="person" style="width:100px;background-color:#3fb0f1"  onmouseout="$(this).css('background-color','#3fb0f1');">个人信息</td>
				...
				<td class="maintblTd" style="padding: 12px 13px;">
					<table class="input-table" cellspacing="0" cellpadding="0" style="border: 0 solid #bfbfbf;">
						<tr style="width:36px;">
							...
							<th colspan="3"><a href="javascript:void();" style="font-size:13px;font-family: 微软雅黑,宋体,Arial,sans-serif;font-weight: normal;padding-right: 38px;color:#0084ce;" onclick="mynews();" >>>&nbsp;MORE</a></th>
						</tr>
						<tr>
							<th style="border-bottom: height: 200px;1px solid #DCDCDC;text-align: center;align:center;vertical-align: top;" >
								<s:if test="person.picture==null">
									<span onmouseover="this.style.color='red';" onclick="itemDetail(${person.id});" onmouseout="this.style.color='#6b6b6b';">
							...
							<td colspan="4"  style="vertical-align:top;">
								...
								<div style="border-bottom: 1px dashed #7FFFD4;" onmouseover="$(this).css('border','1px solid #F5F5F5').css('background-color','#F0F8FF');$(this).find('li').css('border','1px solid #F5F5F5').css('background-color','#F0F8FF');" onmouseout="$(this).css('border','none').css('background-color','#fff');$(this).find('li').css('border','none').css('background-color','#fff').css('border-bottom','1px dashed #7FFFD4');">
								...
								<s:if test='#obj.alrealysee!="1"'>
									<s:if test="#obj.extend=='评论'"> 
											<span onclick="relation('${publishId}');"><img src="images/letter1.png" style="vertical-align: middle;"/>&nbsp;&nbsp;<span style="color:black;"><s:property value="#obj.herNickName" />评论了我的帖子(<s:if test="#obj.sortDetail!='' && #obj.sortDetail!=null">[<s:property value="#obj.sortDetail" />]<s:property value="#obj.title" /></s:if><s:else><s:property value="#obj.title" /></s:else>)</span></span>
									</s:if>
									<s:else>
											<span onclick="relation('${publishId}');"><img src="images/letter1.png" style="vertical-align: middle;"/>&nbsp;&nbsp;<span style="color:black;"><s:property value="#obj.herNickName" />回复了我的评论(<s:if test="#obj.sortDetail!='' && #obj.sortDetail!=null">[<s:property value="#obj.sortDetail" />]<s:property value="#obj.title" /></s:if><s:else><s:property value="#obj.title" /></s:else>)</span></span>
									</s:else>
								</s:if>
								<s:if test='#obj.alrealysee=="1"'>
									<s:if test="#obj.extend=='评论'"> 
											<span onclick="relation('${publishId}');"><img src="images/letter2.png" style="vertical-align: middle;"/>&nbsp;&nbsp;<span style="color:black;"><s:property value="#obj.herNickName" />评论了我的帖子(<s:if test="#obj.sortDetail!='' && #obj.sortDetail!=null">[<s:property value="#obj.sortDetail" />]<s:property value="#obj.title" /></s:if><s:else><s:property value="#obj.title" /></s:else>)</span></span>
									</s:if>
									<s:else>
											<span onclick="relation('${publishId}');"><img src="images/letter2.png" style="vertical-align: middle;"/>&nbsp;&nbsp;<span style="color:black;"><s:property value="#obj.herNickName" />回复了我的评论(<s:if test="#obj.sortDetail!='' && #obj.sortDetail!=null">[<s:property value="#obj.sortDetail" />]<s:property value="#obj.title" /></s:if><s:else><s:property value="#obj.title" /></s:else>)</span></span>
									</s:else>
								</s:if>
								</font>	
								</li>
						...
						<tr>
							...
							<th colspan="3"><a href="javascript:void();" style="font-size:13px;font-family: 微软雅黑,宋体,Arial,sans-serif;font-weight: normal;color:#0084ce;padding-right: 38px;" onclick="myComment();" >>>&nbsp;MORE</a></th>
						</tr>
						<tr>
						...
						<td colspan="4" style="vertical-align:top;">
							...
							<div style="border-bottom: 1px dashed #7FFFD4;margin-left: -15px;" onmouseover="$(this).css('border','1px solid #F5F5F5').css('background-color','#F0F8FF');$(this).find('li').css('border','1px solid #F5F5F5').css('background-color','#F0F8FF');" onmouseout="$(this).css('border','none').css('background-color','#fff');$(this).find('li').css('border','none').css('background-color','#fff').css('border-bottom','1px dashed #7FFFD4');">
							<font style="text-align:right;float: right;font-size:14px;">
								<s:date name="#obj.draftTime" format="yyyy-MM-dd HH:mm"/>
							</font>
							<li style="list-style-type:none;">
							<font style="font-size:14px;" color="black">
								<span onclick="comment('${id}');" ><s:property value="#status.count"/>&nbsp;&nbsp;<span  style="color: black;"><s:if test="#obj.sortDetail!='' && #obj.sortDetail!=null">[${obj.sortDetail}]${obj.title}</s:if><s:else>${obj.title}</s:else></span></span>
							</font>	
							</li>
							</div>
							</s:iterator>
