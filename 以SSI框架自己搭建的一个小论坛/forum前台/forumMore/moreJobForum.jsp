...
<script type="text/javascript">
	...
	//发帖
	function publish(){
		document.forms[0].action="forum/forumAction!draftJob.action";
	...
	<body>
		...
		style="padding: 0px; border-bottom-color: #008B8B" frameborder="0" width="100%" height="107px" scrolling="no" >
     	...
     	<div style="margin-top: 0px;">
			<table width="1000"  align="center" cellpadding="0" cellspacing="0" border="0">
				<tr style="background-color: rgb(47,97,156); height: 40px;color: #ffffff;text-align: center;font-size: 15px;">
					<td id="index" style="width:100px;"  onmouseover="$(this).css('background-color','#3fb0f1');$('#job').css('background-color','rgb(47,97,156)');" onmouseout="$(this).css('background-color','rgb(47,97,156)');$('#job').css('background-color','#3fb0f1');" onclick="window.location.href='<%=basePath %>forum/forumAction!home.action'">首页</td>
					<td id="job" style="width:100px;background-color:#3fb0f1;" onmouseout="$(this).css('background-color','#3fb0f1');">分享工作</td>
					<td id="live" style="width:100px;" onmouseover="$(this).css('background-color','#3fb0f1');$('#job').css('background-color','rgb(47,97,156)');" onmouseout="$(this).css('background-color','rgb(47,97,156)');$('#job').css('background-color','#3fb0f1');" onclick="window.location.href='<%=basePath %>forum/forumAction!liveItems.action'">分享生活</td>
					<td id="live" style="width:100px;" onmouseover="$(this).css('background-color','#3fb0f1');$('#job').css('background-color','rgb(47,97,156)');" onmouseout="$(this).css('background-color','rgb(47,97,156)');$('#job').css('background-color','#3fb0f1');" onclick="window.location.href='<%=basePath %>forum/forumAction!personPage.action'">个人信息</td>
     	...
     	<!-- body -->
		<form action="forum/forumAction!jobItems.action"  method="post">
		<div style="width: 1000px;margin: 0 auto;padding-top: 5px;">
			<div style="border: 1px solid #ace;padding-top: 5px;font-size: 14px;padding-left: 20px;padding-right: 20px;">
				<table width="100%" cellpadding="0" cellspacing="0" style="">
					<tr style="min-height: 36px;">
						...
						<th style="width: 140px;border-bottom:1px dashed #dedede;color:#636363;font-family: 微软雅黑;">创建时间：</th>
			...
			<table id='tbmain' class="amain tbmain" cellpadding="0" cellspacing="0" style="margin-top: 15px;border: 1px solid #ace;">
				<thead>
					<tr>
				...
				<tbody>
				<s:iterator value="#request.forumJobs" var="obj" status="status">
